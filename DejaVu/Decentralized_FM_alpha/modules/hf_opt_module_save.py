...
class GPTBlock(OPTDecoderLayer):
    ...
    def from_pretrained(cls, model_path, config=None, layer_index=None):
        ...
        module.fp_mlp_query = np.memmap(
            f"/home/xujiaming/xujiaming/train_machine/xjm/DATE-25/DejaVu/train_data/7b_c4/mlp_sp_x_{module.layer_index}.mmap",
            dtype="float16",
            mode="w+",
            shape=(
                400000,
        ...
        module.fp_att_query = np.memmap(
            f"/home/xujiaming/xujiaming/train_machine/xjm/DATE-25/DejaVu/train_data/7b_c4/att_sp_x_{module.layer_index}.mmap",
            dtype="float16",
            mode="w+",
            shape=(
                400000,
        ...
        module.fp_label = np.memmap(
            f"/home/xujiaming/xujiaming/train_machine/xjm/DATE-25/DejaVu/train_data/7b/mlp_label_{module.layer_index}.mmap",
            dtype="float16",
            mode="w+",
            shape=(
                400000,
        ...
        module.self_attn.fp_label = np.memmap(
            f"/home/xujiaming/xujiaming/train_machine/xjm/DATE-25/DejaVu/train_data/7b/score_norm_{module.layer_index}.mmap",
            dtype="float16",
            mode="w+",
            shape=(
                400000,
